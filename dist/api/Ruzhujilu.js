...
var _RuzhujiluModel = require('../models/RuzhujiluModel');

var _RuzhujiluModel2 = _interopRequireDefault(_RuzhujiluModel);
...
exports.default = function (_ref) {
	...
	api.get('/page', function () {
		var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(req, res) {
			var page, limit, sort, order, where, yudingdanhao, fangjianmingcheng, fangjiantupian, dingdanjine, yudingriqi, ruzhushijian, ruzhurenshu, ruzhutianshu, banliriqi, tiwenqingkuang, xinxibeizhu, yonghuming, xingming, shouji, shenfenzheng, crossuserid, crossrefid, tableName, result;
				...
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							...
							where = {};
							yudingdanhao = req.query.yudingdanhao;

							if (yudingdanhao) {

								if (yudingdanhao.indexOf('%') != -1) {
									where.yudingdanhao = (0, _defineProperty3.default)({}, _sequelize.Op.like, yudingdanhao);
								} else {
									where.yudingdanhao = (0, _defineProperty3.default)({}, _sequelize.Op.eq, yudingdanhao);
								}
							}
							...
							dingdanjine = req.query.dingdanjine;

							if (dingdanjine) {

								if (dingdanjine.indexOf('%') != -1) {
									where.dingdanjine = (0, _defineProperty3.default)({}, _sequelize.Op.like, dingdanjine);
								} else {
									where.dingdanjine = (0, _defineProperty3.default)({}, _sequelize.Op.eq, dingdanjine);
								}
							}
							yudingriqi = req.query.yudingriqi;

							if (yudingriqi) {

								if (yudingriqi.indexOf('%') != -1) {
									where.yudingriqi = (0, _defineProperty3.default)({}, _sequelize.Op.like, yudingriqi);
								} else {
									where.yudingriqi = (0, _defineProperty3.default)({}, _sequelize.Op.eq, yudingriqi);
								}
							}
							ruzhushijian = req.query.ruzhushijian;

							if (ruzhushijian) {

								if (ruzhushijian.indexOf('%') != -1) {
									where.ruzhushijian = (0, _defineProperty3.default)({}, _sequelize.Op.like, ruzhushijian);
								} else {
									where.ruzhushijian = (0, _defineProperty3.default)({}, _sequelize.Op.eq, ruzhushijian);
								}
							}
							ruzhurenshu = req.query.ruzhurenshu;

							if (ruzhurenshu) {

								if (ruzhurenshu.indexOf('%') != -1) {
									where.ruzhurenshu = (0, _defineProperty3.default)({}, _sequelize.Op.like, ruzhurenshu);
								} else {
									where.ruzhurenshu = (0, _defineProperty3.default)({}, _sequelize.Op.eq, ruzhurenshu);
								}
							}
							ruzhutianshu = req.query.ruzhutianshu;

							if (ruzhutianshu) {

								if (ruzhutianshu.indexOf('%') != -1) {
									where.ruzhutianshu = (0, _defineProperty3.default)({}, _sequelize.Op.like, ruzhutianshu);
								} else {
									where.ruzhutianshu = (0, _defineProperty3.default)({}, _sequelize.Op.eq, ruzhutianshu);
								}
							}
							banliriqi = req.query.banliriqi;

							if (banliriqi) {

								if (banliriqi.indexOf('%') != -1) {
									where.banliriqi = (0, _defineProperty3.default)({}, _sequelize.Op.like, banliriqi);
								} else {
									where.banliriqi = (0, _defineProperty3.default)({}, _sequelize.Op.eq, banliriqi);
								}
							}
							tiwenqingkuang = req.query.tiwenqingkuang;

							if (tiwenqingkuang) {

								if (tiwenqingkuang.indexOf('%') != -1) {
									where.tiwenqingkuang = (0, _defineProperty3.default)({}, _sequelize.Op.like, tiwenqingkuang);
								} else {
									where.tiwenqingkuang = (0, _defineProperty3.default)({}, _sequelize.Op.eq, tiwenqingkuang);
								}
							}
							xinxibeizhu = req.query.xinxibeizhu;

							if (xinxibeizhu) {

								if (xinxibeizhu.indexOf('%') != -1) {
									where.xinxibeizhu = (0, _defineProperty3.default)({}, _sequelize.Op.like, xinxibeizhu);
								} else {
									where.xinxibeizhu = (0, _defineProperty3.default)({}, _sequelize.Op.eq, xinxibeizhu);
								}
							}
							...
							_context.next = 44;
							return _RuzhujiluModel2.default.findAndCountAll({
								order: [[sort, order]],
								where: where,
								offset: (page - 1) * limit,
								limit: limit
	...
	api.get('/list', function () {
		var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(req, res) {
			var page, limit, sort, order, where, crossuserid, crossrefid, yudingdanhao, fangjianmingcheng, result;
				...
				while (1) {
					switch (_context3.prev = _context3.next) {
						case 0:
							...
							_context3.next = 4;
							return _RuzhujiluModel2.default.create(req.body);
				...
				while (1) {
					switch (_context5.prev = _context5.next) {
						case 0:
							_context5.prev = 0;
							_context5.next = 3;
							return _RuzhujiluModel2.default.update(req.body, {
								where: {
									id: req.body.id || 0
								}
							});
				...
				while (1) {
					switch (_context6.prev = _context6.next) {
						case 0:
							_context6.prev = 0;
							_context6.next = 3;
							return _RuzhujiluModel2.default.destroy({
								where: {
				...
				while (1) {
					switch (_context7.prev = _context7.next) {
						case 0:
							...
							_context7.t1 = res;
							_context7.next = 5;
							return _RuzhujiluModel2.default.findOne({ where: { id: req.params.id } });
						...
						case 0:
							...
							if (req.params.type == 2) {
								...
								if (req.query.remindstart && req.query.remindend) {
									...
									sql = "SELECT COUNT(*) AS count FROM ruzhujilu WHERE " + req.params.columnName + " >= '" + _remindStart + "' AND " + req.params.columnName + " <= '" + _remindEnd + "'";
								}
							}
...
//# sourceMappingURL=Ruzhujilu.js.map