	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="预订单号" prop="yudingdanhao">
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="订单金额" prop="dingdanjine">
					<el-input v-model="ruleForm.dingdanjine" placeholder="订单金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="预定日期" prop="yudingriqi">
					<el-input v-model="ruleForm.yudingriqi" placeholder="预定日期" clearable  :readonly="ro.yudingriqi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="预定日期" prop="yudingriqi">
					<el-input v-model="ruleForm.yudingriqi" placeholder="预定日期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="入住时间" prop="ruzhushijian">
					<el-input v-model="ruleForm.ruzhushijian" placeholder="入住时间" clearable  :readonly="ro.ruzhushijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="入住时间" prop="ruzhushijian">
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="date" v-if="type!='info'" label="办理日期" prop="banliriqi">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-else-if="ruleForm.banliriqi" label="办理日期" prop="banliriqi">
					<el-input v-model="ruleForm.banliriqi" placeholder="办理日期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="体温情况" prop="tiwenqingkuang">
					<el-input v-model="ruleForm.tiwenqingkuang" placeholder="体温情况" clearable  :readonly="ro.tiwenqingkuang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="体温情况" prop="tiwenqingkuang">
					<el-input v-model="ruleForm.tiwenqingkuang" placeholder="体温情况" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="信息备注" prop="xinxibeizhu">
					<el-input v-model="ruleForm.xinxibeizhu" placeholder="信息备注" clearable  :readonly="ro.xinxibeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="信息备注" prop="xinxibeizhu">
	...
	data() {
		...
		return {
			...
			rules: {
				...
				tiwenqingkuang: [
					{ required: true, message: '体温情况不能为空', trigger: 'blur' },
				],
				xinxibeizhu: [
				],
				yonghuming: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='tiwenqingkuang'){
							this.ruleForm.tiwenqingkuang = obj[o];
							this.ro.tiwenqingkuang = true;
							continue;
						}
						if(o=='xinxibeizhu'){
