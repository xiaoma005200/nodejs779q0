  ...
  <div class="main-content">
    ...
    <template v-if="showFlag">
      <el-form
        ...
        :style='{"width":"100%","margin":"0 0 20px","flexWrap":"wrap","display":"flex"}'
        :inline="true"
        :model="searchForm"
      >
        <el-row :style='{"width":"100%","display":"block","order":"2"}'>
          ...
          <el-button
            :style='{"cursor":"pointer","padding":"0 30px","boxShadow":"4px 4px 2px #ddd","borderColor":"#798fe1","margin":"0 0 0 10px","color":"#798fe1","outline":"none","borderRadius":"0","background":"#eaf2fa","borderWidth":"4px","width":"auto","fontSize":"16px","lineHeight":"40px","borderStyle":"solid double solid double","height":"44px"}'
            type="success"
            @click="search()"
          >查询</el-button>
        </el-row>
        ...
        <el-row
          :style='{"width":"100%","padding":"0","margin":"20px 0 20px","background":"none","display":"flex"}'
        >
          <el-button
            :style='{"border":"1px dotted #a347ea","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#a347ea","borderRadius":"0px","background":"#f3eafa","width":"auto","fontSize":"14px","height":"40px"}'
            v-if="isAuth('huiyuan','新增')"
            type="success"
            @click="addOrUpdateHandler()"
          >新增</el-button>
          <el-button
            :style='{"border":"1px dotted #df2543","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#df2543","borderRadius":"0px","background":"#fcecef","width":"auto","fontSize":"14px","height":"40px"}'
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <el-button
              :style='{"border":"1px solid #a347ea","cursor":"pointer","padding":"0 16px","margin":"3px 6px 3px 0","outline":"none","color":"#a347ea","borderRadius":"20px","background":"#f3eafa","width":"auto","fontSize":"14px","height":"32px"}'
              v-if=" isAuth('huiyuan','查看')"
              type="success"
              size="mini"
            ...
            <el-button
              :style='{"border":"1px solid #dc333b","cursor":"pointer","padding":"0 16px","margin":"3px 6px 3px 0","outline":"none","color":"#dc333b","borderRadius":"20px","background":"#fbeced","width":"auto","fontSize":"14px","height":"32px"}'
              v-if="isAuth('huiyuan','删除') "
              type="danger"
              size="mini"
...
.center-form-pv .el-input /deep/ .el-input__inner {
  ...
  outline: none;
  color: #999;
  background: url(http://codegen.caihongy.cn/20221130/b1773df61c064cc8933eefc9217e387b.png)
    no-repeat;
  width: 191px;
  font-size: 14px;
  height: 44px;
